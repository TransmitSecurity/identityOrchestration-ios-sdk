...
Pod::Spec.new do |spec|
    ...
    spec.source       = { :git => "https://github.com/TransmitSecurity/identityOrchestration-ios-sdk.git", :tag => "#{spec.version}" }
    ...
    spec.vendored_frameworks = "Sources/IdentityOrchestration.xcframework*"
    ...
    spec.dependency "TSCoreSDK", "~> 0.1.202512232213"
